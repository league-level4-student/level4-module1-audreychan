...
public class Snake {
	...
	public boolean isOutOfBounds() {
		...
		//   and false otherwise
		int width = _00_SnakeGame.WIDTH;
		int height = _00_SnakeGame.HEIGHT; 
		if(getHeadLocation().x >= width || getHeadLocation().x < 0 || getHeadLocation().y >= height || getHeadLocation().y < 0) {
			return true;
		}
		return false;
	}
